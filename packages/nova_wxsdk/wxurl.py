...
class WxApiUrl(object):
    ...
    set_headimg = "http://api.weixin.qq.com/customservice/kfaccount/uploadheadimg?access_token={access_token}&kf_account={kf_account}"
    ...
    download_temp_media = "https://api.weixin.qq.com/cgi-bin/media/get?access_token={access_token}&media_id={media_id}"
    upload_perm_media = "https://api.weixin.qq.com/cgi-bin/material/add_material?access_token={access_token}&type={type}"
